...
namespace ApiAuthorizationAA.Service.Cryptography.SHA
{
    ...
    public class EncryptShaServices
    {
    }
    ...
    public class PasswordHashProvider : IEncryptShaServices
    {
        /// <summary>
        ...
        public PasswordHashContainerEntity CreateHash(string password)
        {
        ...
        public bool ValidatePassword(string password, byte[] salt, byte[] correctHash)
        {
            // Extract the parameters from the hash
        ...
        public bool CompareHashes(byte[] array1, byte[] array2)
        {
